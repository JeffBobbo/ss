...
BobboBot::module::addCommand('condense', 'run', \&BobboBot::condense::run);
BobboBot::module::addCommand('condense', 'help', \&BobboBot::condense::help);
BobboBot::module::addCommand('condense', 'auth', \&BobboBot::condense::auth);
